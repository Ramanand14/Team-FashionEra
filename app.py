...
@app.route("/outfit2", methods=["GET","POST"])
def outfit1():
    return render_template("outfit2.html")

@app.route("/outfit3", methods=["GET","POST"])
def outfit1():
    return render_template("outfit3.html")

@app.route("/outfit4", methods=["GET","POST"])
def outfit1():
    return render_template("outfit4.html")

@app.route("/outfit5", methods=["GET","POST"])
def outfit1():
    return render_template("outfit5.html")

@app.route("/outfit6", methods=["GET","POST"])
def outfit1():
    return render_template("outfit6.html")

@app.route("/outfit7", methods=["GET","POST"])
def outfit1():
    return render_template("outfit7.html")

@app.route("/outfit8", methods=["GET","POST"])
def outfit1():
    return render_template("outfit8.html")
