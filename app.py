...
def login():
    ...
    if request.method=='POST':
        ...
        for row in rows:
            print("\n*Personal Details*\nName:",row[1],"\nEmail: ",row[2],"\n\n*Address Details*\nAddress:",row[3],"\nDOB:",row[4],"\n\n*Contact Details*\nMobile:",row[5],"\nPrivate_Key:",row[8])
            if rows is None:
                flash("Invalid username or password.", category='error3')
...
def forgot_page():
    ...
    if request.method=='POST':
        ...
        for row in rows:
            ...
            if rows is None:
                print("here")
                flash("Invalid Email or private key.", category='error2')
                return render_template("forgot_page.html")
            else:
                print("there")
                flash("Password has been sent to you. Kindly check your mailbox PRIMARY or SPAM.", category='success2')
...
def delete_page():
    ...
    if request.method=='POST':
        ...
        for row in rows:
            ...
            if rows is None:
                print("here")
                flash("Account with given Email and Password does not exists.", category='error1')
                return render_template("delete_page.html")
            else:
                print("there")
                flash("Your account deleted successfully.", category='success1')
